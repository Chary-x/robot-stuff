...
### REQUIRED ###
# OPENCM3_DIR - duh
# PROJECT_NAME - will be the basename of the output elf, eg usb-gadget0-stm32f4disco
...
GENERATED_BINS = $(PROJECT_NAME).elf $(PROJECT_NAME).bin $(PROJECT_NAME).map $(PROJECT_NAME).list $(PROJECT_NAME).lss
...
# OPTIONAL
#TGT_LDFLAGS += -Wl,-Map=$(PROJECT_NAME).map
ifeq ($(V),99)
...
$(PROJECT_NAME).elf: $(OBJS) $(LDSCRIPT) $(LIBDEPS)
	@printf "  LD\t$@\n"
